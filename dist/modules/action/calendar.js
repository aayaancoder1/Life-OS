...
if (config.GOOGLE_CLIENT_ID &&
    ...
    const oauth2Client = new google.auth.OAuth2(config.GOOGLE_CLIENT_ID, config.GOOGLE_CLIENT_SECRET, config.GOOGLE_REDIRECT_URI || 'http://localhost');
    ...
    console.warn('WARNING: Google Calendar credentials are missing in environment configuration. Running Action Module in MOCK mode.');
}
